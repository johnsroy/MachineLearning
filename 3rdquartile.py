...
plt.title('Percentile Distribution of the number of releases shown till the 3rd Quartile(75th Percentile)')
plt.ylabel("Release number")
plt.xlabel("Percentiles and 1st,2nd and 3rd Quartiles")
plt.show()
